...
export declare const mockFetch: (payload: string, statusCode: number) => import("jest-mock").Mock<(_url: RequestInfo | URL, _init?: RequestInit) => ReturnType<typeof window.fetch>>;
